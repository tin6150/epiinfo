...
# determine which 6 seq Tilden dropped, vimdiff already show them to be R S T W Y Z, confirmed here
# come to think of it, it is the last 6 records she is dropping.  U V X were previously not submitted for sequencing.
...
vimdiff, Res+MLST result, the 44 vs 50 rows version, likely removed these rows:
ResMlstCombTableTsv vs ResMlstCombTableTsv50  

6/9/23  2C  WATER S R_CKDN230030148-1A_HGKHYDSX7_L2_Abricate_resfinder.tsv    paeruginosa 1414  acsA(40)  aroE(5) guaA(6) mutL(5) nuoD(2) ppsA(4) trpE(26)           
5/30/23 3C  WATER S S_CKDN230030149-1A_HGKHYDSX7_L2_Abricate_resfinder.tsv    ecoli 2705  adk(10) fumC(11)  gyrB(4) icd(10) mdh(7)  purA(8) recA(2) 
6/14/23 3C  WATER E T_CKDN230030150-1A_HGKHYDSX7_L2_Abricate_resfinder.tsv    aeromonas - gyrB(241) groL(93)  gltA(~238)  metG(~272)  ppsA(~440)  recA(~416)
5/30/23 1C  WATER S W_CKDN230030151-1A_HGKHYDSX7_L2_Abricate_resfinder.tsv    ecoli 48  adk(6)  fumC(11)  gyrB(4) icd(8)  mdh(8)  purA(8) recA(2)   
6/14/23 3C  WATER D Y_CKDN230030152-1A_HGKHYDSX7_L2_Abricate_resfinder.tsv    ecoli 48  adk(6)  fumC(11)  gyrB(4) icd(8)  mdh(8)  purA(8) recA(2)
6/14/23 3C  WATER D Z_CKDN230030153-1A_HGKHYDSX7_L2_Abricate_resfinder.tsv  
#                   ^^ sample id, not the dups I thought... 
confirmed in R (vs vimdiff) to dropped: R S T W Y Z
come to think of it, it is the last 6 records she is dropping.  U V X were previously not submitted for sequencing.
