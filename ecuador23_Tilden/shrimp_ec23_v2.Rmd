...
# check for dup (and sanity check)
...
mlst_resfind_vfdb_df_condensed = mlst_resfind_vfdb_ecvf_df %>% # prev: mlst_resfind_vfdb_df %>%
  select( 1:16, 77:83, 405:408 )


# View( mlst_resfind_vfdb_df_condensed )

mlst_resfind_vfdb_df_checkDup = mlst_resfind_vfdb_df %>%
  select( Filename, PubMLST_scheme_name, SeqType, RESIST_NUM_FOUND, VFDB_NUM_FOUND, sample_name, Hnum, Lnum )

# View( mlst_resfind_vfdb_df_checkDup )

mlst_resfind_vfdb_ecvf_df_checkDup = mlst_resfind_vfdb_ecvf_df %>%
  select( Filename, source,  PubMLST_scheme_name, SeqType, RESIST_NUM_FOUND, VFDB_NUM_FOUND, ECVF_NUM_FOUND, sample_name.x, Hnum.x, Lnum.x )
