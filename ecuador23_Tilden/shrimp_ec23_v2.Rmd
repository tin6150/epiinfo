...
# Example usage:   ## this not needed anymore
# Create a sample dataframe
df <- data.frame(
  Set1 = c("A,B,C", "D,E", "G,H"),
  Set2 = c("B,C,D", "E,F", "H,I"),
  Set3 = c("C,D,E", "", "I,J"),
  Set4 = c("D,E,F", "F,G", "")
)
...
specieAndArg = resGeneBySpecieCount %>%
  select( Specie_Name, gene ) %>% as.data.frame() 

specieAndArg4venn <- df_to_set_list( specieAndArg )
```
...
x = specieAndArg4venn  ## Sn50   not, not the List of Set needed.
