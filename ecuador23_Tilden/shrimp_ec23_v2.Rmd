...
#// avg here is 2.5
#// this is wrong stat, need to be more sample specific, so use number below.

## summary( resAmrCountByCategory )  # not the stat needed here

# View( resultV2 )

resGeneBySample = resultV2 %>% select( sample_name, RESIST_NUM_FOUND )
summary( resGeneBySample )
