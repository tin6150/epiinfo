...
## there are position of the MGE... no gene names... might need additional work?  or in other results files?

MOBrecon_result_file = sprintf( "%s/%s", DATADIR, "MOB_recon_combined.mge.report.tsv")
MOBrecon_result_tsv = read_tsv( MOBrecon_result_file, col_types = list( .default=col_character() ) )
View( MOBrecon_result_tsv )
