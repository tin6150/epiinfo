...
# don't know what the tibble source col persist and wrecking my gene count per amr_type wrong.  pivot wider just to circumvent the problem!
...
View( resAmrCountByGene_wide )

```

```{r theseProbNotNeededAnymore }
# Sn_tmpFig4 = 
genes_of_amrClass = 
