...
Elements in Aeromonas_spp but not in other sets:
...
Elements in Citrobacter freundii but not in other sets:
c("blaCMY-98_1", "qnrB69_1") 

Elements in Enterobacter cloacae but not in other sets:
c("blaCMH-3_1", "fosA_7", "oqxA_1", "oqxB_1") 

Elements in Escherichia coli but not in other sets:
...
Elements in Klebsiella pneumoniae but not in other sets:
...
Elements in Pseudomonas putida but not in other sets:
c("aph(3')-IIb_2", "blaOXA-485_1", "blaOXA-486_1", "blaPAO_2", "blaPAO_4", "catB7_1", "fosA_4") 
