...
```{r fig3, eval=T}
##++ FIXME ... here is really it bork, cuz of ggtext .  weasel p_load(ggtext) works, but seems not on zyzyxia3
...
MOBrecon_mge_result_lng = MOBrecon_mge_result_tsv %>%
...
writexl::write_xlsx( mgeResult4discuss, "TMP/mgeResult4discuss.TMP.XLSX" )
