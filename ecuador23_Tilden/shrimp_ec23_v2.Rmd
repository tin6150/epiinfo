...
# new try, seems to get more of Only set 1 & 2 kind of combination.
...
sorted_intersections <- names(intersections)[order(sapply(strsplit(names(intersections), "&"), length))]
