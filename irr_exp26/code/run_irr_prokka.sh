...
rename_gff() {
	...
	echo "used bash this time, ran manually"
	# mkdir ../PROKKA_gff
	# cat gff_list.TXT | awk -F_ '{print "mv -i " $0 " ../PROKKA_gff/EC_" $3 ".gff" }' > renameGff.sh
	# in rename.sh, eg: 
	# mv -i EC-AI-5395_52_54_assembly.gff ../PROKKA_gff/EC_54.gff
}
